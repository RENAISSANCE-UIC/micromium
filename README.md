...
> **IMPORTANT:** We need you to test this out and get back to us. We are going to be filing an application for [SignPath](https://signpath.org/) and this helps us make the case for the Reputation criteria. Verabatim, these are:
